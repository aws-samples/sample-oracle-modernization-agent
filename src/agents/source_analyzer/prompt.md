...
4. Save results to database (HTML report is auto-generated by the pipeline)
...
| Tool | Purpose |
|------|---------|
| `analyze_sql_patterns()` | Extract Top 10 complex SQLs from extract_record (DB) |
